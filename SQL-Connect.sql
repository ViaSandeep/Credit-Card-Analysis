...
COPY cc_detail
FROM 'F:\Power BI\PowerBI Projects\Credit Card Financial Dashboard\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'F:\Power BI\PowerBI Projects\Credit Card Financial Dashboard\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'F:\Power BI\PowerBI Projects\Credit Card Financial Dashboard\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'F:\Power BI\PowerBI Projects\Credit Card Financial Dashboard\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
